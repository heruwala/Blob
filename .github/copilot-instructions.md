...
- **Format**: ISO 8601 with milliseconds (e.g., `2026-01-08T13:00:00.000Z`)

#### 3. END_TIMESTAMP
- **Purpose**: When the maintenance window ends
- **Value**: User-provided end time converted from Eastern Time to UTC
- **Format**: ISO 8601 with milliseconds (e.g., `2026-01-09T16:00:00.000Z`)
...
- END: `2026-01-09T16:00:00.000Z` (Nov 8, 6 PM EST + 5 hours)

**Validation**: ✅ `2025-11-06T18:00:00.000Z` < `2026-01-08T13:00:00.000Z` < `2026-01-09T16:00:00.000Z`
